  ...
  return (
    <motion.div
      ...
      <p className="text-lg font-bold mb-6 mx-8 lg:mx-12 lg:text-2xl">
        We have developed an efficient design process that brings solid results
      ...
      <h1 className="text-2xl lg:text-4xl">70%</h1>
      <p className="text-lg lg:text-2xl">less time on development</p>
    </motion.div>
  );
}
